...
class VerifyEmail extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->action(Lang::getFromJson('Confirma tu dirección de correo electrónico'), $verificationUrl)
            ->line(Lang::getFromJson('Si no haz creado una cuenta, no es necesario hacer nada más.'))
            ->salutation('¡Saludos!');
    }
